...
{
    return Inertia::render('Admin/Setting/Bank');
}
 public function products(Request $request)
{
    return Inertia::render('Admin/Setting/Products');
}
public function termsConditions(Request $request)
{
    return Inertia::render('Admin/Setting/TermsConditions');
}
public function tdsTaxSlabs(Request $request)
{
    return Inertia::render('Admin/Setting/TdsTaxSlabs');
}
}