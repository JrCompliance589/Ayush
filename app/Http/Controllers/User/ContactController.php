...
class ContactController extends BaseController
{
    ...
    public function import(Request $request) {
        ...
        // Record contact additions for lifetime subscribers
        if ($successfulImports > 0) {
            $organizationId = session()->get('current_organization');
            if (LifetimeSubscriptionService::hasLifetimeSubscription($organizationId)) {
                LifetimeSubscriptionService::recordContactAddition($organizationId, $successfulImports);
            }
        }
    ...
    public function store(StoreContact $request){
        ...
        // Record contact addition for lifetime subscribers
        $organizationId = session()->get('current_organization');
        if (LifetimeSubscriptionService::hasLifetimeSubscription($organizationId)) {
            LifetimeSubscriptionService::recordContactAddition($organizationId, 1);
        }
