                    ...
                    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md">
                        <div class="p-6">
                            ...
                            <div class="text-center mb-6">
                                <h3 class="text-lg font-bold text-slate-900 mb-2">{{ $t('Delete Product') }}</h3>
                                ...
                                <div class="bg-slate-50 rounded-xl p-4 text-left">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-semibold text-slate-900 mb-1">{{ product.name }}</p>
                                            <p class="text-xs text-slate-600">{{ formatCurrency(product.amount) }}</p>
                                            <p v-if="product.category" class="text-xs text-slate-500 mt-1">{{
                                                product.category }}</p>
                                        </div>
                                    </div>
                                </div>
