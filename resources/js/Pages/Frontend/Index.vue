    ...
    <div :class="rtlClass">
        ...
        <section id="section1" class="pt-4 md:pt-10 px-5 md:px-10 lg:px-20 2xl:px-60 relative">
            <div class="flex justify-between items-center">
                ...
                <img class="max-w-[150px]" v-if="props.companyConfig.logo" :src="'/media/' + props.companyConfig.logo"
                ...
                <div class="flex justify-end items-center text-md">
                    <Link href="/login"
                        class="hidden md:inline-block mr-10 cursor-pointer hover:text-gray-400 border-black">{{
                            $t('Login') }}</Link>
                    <Link href="/signup"
                        class="hidden md:inline-block bg-primary hover:bg-secondary text-white p-2 rounded-lg text-sm w-fit px-8">
                    {{ $t('Sign Up') }}</Link>
                    <Link href="/login"
                        class="md:hidden bg-primary hover:bg-secondary text-white p-2 rounded-lg text-sm flex w-fit px-8">
                    {{ $t('Login') }}</Link>
                </div>
            </div>
            <div class="flex justify-center mt-[7%] h-full">
                <div class="relative z-10">
                    <div class="flex justify-center mb-6">
                        <div class="bg-secondary/10 text-primary text-sm py-2 px-4 inline-block rounded-full mb-6 aos-init aos-animate"
                    ...
                    <div class="flex justify-center">
                        <h1 class="text-center text-3xl md:text-5xl leading-[1.3] w-3/4">{{ $t(`Revolutionise Your
                            Whatsapp Messaging Today`) }}</h1>
                    </div>
                    <div class="flex justify-center">
                        <h2 class="text-center font-light text-gray-700 text-md md:text-xl mt-8 w-3/4">{{ $t(`Send
                            multiple whatsapp campaigns, immerse in seamless chats & collaborate with your team
                            effortlessly`) }}.</h2>
                    </div>
                    <div class="md:flex md:flex-row md:justify-center md:space-x-2 space-y-4 md:space-y-0 mt-10">
                        <div>
                            <input type="text" class="w-full border-2 border-primary rounded-lg py-2 px-4 z-10"
                                :placeholder="$t('First name')">
                        </div>
                        <div>
                            <input type="text" class="w-full border-2 border-primary rounded-lg py-2 px-4"
                                :placeholder="$t('Email')">
                        </div>
                        <Link href="/signup"
                            class="py-2 px-4 bg-primary hover:bg-secondary rounded-lg flex justify-center items-center text-center text-white">
                    ...
                    <div class="flex flex-wrap justify-center items-center gap-5 mt-5 z-10">
                        <div v-if="props.companyConfig.trial_period" class="flex items-center gap-2">
                            <svg class="w-5 h-5 text-secondary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
        ...
        <section id="section2" class="mt-[7em] px-5 md:px-10 lg:px-20 py-20 2xl:px-60">
            <div class="flex justify-center mb-2">
                <div class="bg-secondary/10 text-secondary py-1 px-4 inline-block rounded-full mb-6 aos-init aos-animate"
                    data-aos="fade-right" data-aos-duration="1000">
                    <a href="#">
                        <div class="flex items-center gap-2">
                            <div>{{ $t('Features') }}</div>
            ...
            <div class="flex justify-center">
                <h2 class="text-center text-3xl md:text-5xl font-bold w-[10em] capitalize">{{ $t(`Whatsapp messaging
                    done differently`) }}</h2>
            </div>
            <div class="flex justify-center">
                <h3 class="text-center text-[18px] mt-5 w-[33em]">{{ $t(`Elevate your communication game and unlock a
                    host of powerful features tailored to enhance your business\'s WhatsApp experience:`) }}</h3>
            </div>
            <div
                class="bg-gray-300/10 rounded-[20px] px-5 md:px-10 py-10 grid lg:grid-cols-2 grid-cols-1 gap-6 items-center mt-14">
                <div class="">
                    <img :src="'images/hero/dashboard3.png'" alt="dashboard" data-aos="fade-right"
                        data-aos-duration="400" class="aos-init aos-animate">
                </div>
                <div class="lg:ms-24">
                    <div @click="selectedFeature = 1" class="bg-white rounded-lg px-2 py-2 mb-5">
                        <div class="flex justify-between items-center cursor-pointer">
                            <div class="flex items-center space-x-3">
                                <div class="bg-secondary/10 rounded-lg flex items-center justify-center h-10 w-10">
                                    <svg class="h-6 w-6 text-secondary" xmlns="http://www.w3.org/2000/svg" width="1em"
                                        height="1em" viewBox="0 0 26 26">
                                        <g fill="currentColor">
                                            <path
                                                d="M8.05 17.95a1 1 0 1 1 1.414-1.415A5 5 0 0 0 18 13a1 1 0 1 1 2 0a7 7 0 0 1-11.95 4.95" />
                                            <path d="M16.559 15.832a1 1 0 1 1-1.11-1.664l3-2a1 1 0 1 1 1.11 1.664z" />
                                            <path
                                            ...
                                            <path d="M4.075 10.356a1 1 0 1 1 1.664-1.11l2 3a1 1 0 1 1-1.664 1.11z" />
                            ...
                            <div>
                                <svg v-if="selectedFeature != 1" xmlns="http://www.w3.org/2000/svg" width="1em"
                        ...
                        <div v-if="selectedFeature === 1" class="mt-2">
                            <p class="text-gray-700 dark:text-gray-300 font-light">
                                {{ $t(`Engage with your audience in real-time through the WhatsApp Cloud API, ensuring
                    ...
                    <div @click="selectedFeature = 2" class="bg-white rounded-lg px-2 py-2 mb-5">
                        <div class="flex justify-between items-center cursor-pointer">
                            ...
                            <div>
                                <svg v-if="selectedFeature != 2" xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M16.75 11.989a1.82 1.82 0 0 1-.57 1.36l-6.82 6.1a1.27 1.27 0 0 1-.65.31h-.19a1.3 1.3 0 0 1-.52-.1a1.23 1.23 0 0 1-.54-.47a1.19 1.19 0 0 1-.21-.68v-13a1.2 1.2 0 0 1 .21-.69a1.23 1.23 0 0 1 1.25-.56c.24.039.464.143.65.3l6.76 6.09c.19.162.344.363.45.59c.114.234.175.49.18.75" />
                                </svg>
                        ...
                        <div v-if="selectedFeature === 2" class="mt-2">
                            <p class="text-gray-700 dark:text-gray-300 font-light">
                                {{ $t(`Seamlessly integrate our platform into your systems with user-friendly API
                    ...
                    <div @click="selectedFeature = 3" class="bg-white rounded-lg px-2 py-2 mb-5">
                        <div class="flex justify-between items-center cursor-pointer">
                            ...
                            <div>
                                <svg v-if="selectedFeature != 3" xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M16.75 11.989a1.82 1.82 0 0 1-.57 1.36l-6.82 6.1a1.27 1.27 0 0 1-.65.31h-.19a1.3 1.3 0 0 1-.52-.1a1.23 1.23 0 0 1-.54-.47a1.19 1.19 0 0 1-.21-.68v-13a1.2 1.2 0 0 1 .21-.69a1.23 1.23 0 0 1 1.25-.56c.24.039.464.143.65.3l6.76 6.09c.19.162.344.363.45.59c.114.234.175.49.18.75" />
                                </svg>
                        ...
                        <div v-if="selectedFeature === 3" class="mt-2">
                            <p class="text-gray-700 dark:text-gray-300 font-light">
                                {{ $t(`Enrich conversations effortlessly by sharing images, documents, and multimedia
                                content, enhancing your overall communication strategy`) }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 items-center mt-10">
                <div class="bg-gray-300/10 rounded-[20px] px-5 md:px-10 py-10 order-2 lg:order-1" data-aos="fade-up"
                    data-aos-duration="500">

                    <div class="h-12 w-12 bg-primary/10 flex items-center justify-center rounded-lg">
                        <svg class="h-6 w-6 text-secondary" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                    ...
                    <p class="text-gray-500">{{ $t(`Streamline your communication strategy with our platform\'s dual
                        capabilities.Engage in effortless one - on - one conversations with your contacts while also
                        harnessing the power to execute targeted bulk messaging campaigns`) }}</p>
                </div>
                ...
                <div class="bg-gray-300/10 rounded-[20px] px-5 md:px-10 py-10 order-2 lg:order-1" data-aos="fade-up"
                    ...
                    <p class="text-gray-500">{{ $t(`Take control of your operational efficiency and streamline your
                        workflow effortlessly with our customizable automated response system.Craft responses tailored
                        to your unique needs, guaranteeing swift message delivery to your audience`) }}</p>
                </div>
            </div>
        </section>
        ...
        <section id="section3" class="px-5 md:px-10 lg:px-20 py-20 2xl:px-60">
            <div>
                ...
                <div class="flex justify-center">
                    <h2 class="text-center text-3xl md:text-5xl font-bold w-[11em]">{{ $t(`A step-by-step guide to our
                        platform`) }}</h2>
                </div>
                <div class="flex justify-center">
                    <h3 class="text-center text-[18px] mt-5 w-[33em]">{{ $t(`Explore our platform with ease! Sign up,
                        connect your whatsapp account, and start communicating with your customers`) }}</h3>
                </div>
                <div
                    class="flex justify-between items-center gap-6 md:gap-4 lg:gap-6 stp-15 relative max-md:flex-col mt-10">
                    <img :src="'/images/shapes/stepArrow1.png'" alt=""
                        class="absolute top-14 right-[22%] max-xxl:right-[23%] max-xxl:top-24 max-xxl:w-[200px] max-lg:right-[25%] max-lg:w-[100px] max-md:hidden">
                    <img :src="'/images/shapes/stepArrow2.png'" alt=""
                        class="absolute top-8 left-[21%] max-xxl:top-20 max-xxl:left-[23%] max-xxl:w-[200px] max-lg:left-[25%] max-lg:w-[100px] max-md:hidden">
                    <div class="flex justify-center items-center text-center flex-col max-w-[350px]">
                        <div
                            class="text-s1 text-secondary bg-softBg border border-strokeColor rounded-full p-6 lg:p-7 text-3xl lg:text-5xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                <defs>
                                    <mask id="letsIconsUserScanDuotoneLine0">
                                        <g fill="none" stroke-linecap="round">
                                            <path stroke="silver" stroke-opacity="0.25"
                        ...
                        <p class="font-light">{{ $t(`Get started in a few clicks. Seamless registration, hassle-free
                            access to a world of possibilities awaits you`) }}</p>
                    </div>
                    <div class="flex justify-center items-center text-center flex-col max-w-[350px]">
                        <div
                            class="text-s1 text-secondary bg-softBg border border-strokeColor rounded-full p-6 lg:p-7 text-3xl lg:text-5xl">
                        ...
                        <p class="font-light">{{ $t(`Quick and easy setup for your personalized WhatsApp instance. Begin
                            engaging with your contacts in no time`) }}.</p>
                    </div>
                    <div class="flex justify-center items-center text-center flex-col max-w-[350px]">
                        <div
                            class="text-s1 text-secondary bg-softBg border border-strokeColor rounded-full p-6 lg:p-7 text-3xl lg:text-5xl">
                        ...
                        <p class="font-light">{{ $t(`Embark on your journey to success. Initiate your inaugural campaign
                            effortlessly and witness the power of impactful outreach`) }}</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div>
                <div class="relative">
                    ...
                    <div class="text-center">
                        <div class="flex justify-center mb-2">
                            <div class="bg-secondary/10 text-secondary py-1 px-4 inline-block rounded-full mb-4 aos-init aos-animate"
                                data-aos="fade-right" data-aos-duration="1000">
                                <a href="#">
                                    <div class="flex items-center gap-2">
                                        <div>{{ $t('Plans') }}</div>
                        ...
                        <div class="flex justify-center">
                            <h3 class="text-center text-[18px] mt-5 w-[33em]">{{ $t(`Whether you\'re an individual, a
                                small team, or a growing enterprise, we have a plan that aligns perfectly with your
                                goals`) }}</h3>
                        </div>
                    </div>
                    ...
                    <div class="grid xl:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-5 mt-14">
                        ...
                        <!-- 2 -->
                        <div v-for="(item, index) in props.plans" :key="index" data-aos="fade-up"
                            ...
                            <div class="transition-all duration-300 pointer-events-auto">
                                <div class="bg-gray-300/10 w-full h-full p-10 rounded-[12px]">
                                    ...
                                    <div class="flex mt-8">
                                        <Link href="/signup"
                                            class="bg-primary hover:bg-secondary text-center text-white w-full py-3 rounded-lg border border-transparent focus:outline focus:outline-primary/50 transition-all duration-300">
                                        {{ $t('Select Plan') }}</Link>
                                    </div>
                                    <div class="mt-5">
                                        <div class="flex flex-col space-y-2">
                                            <div class="flex items-center text-gray-600 gap-3">
                                                ...
                                                <h3>{{ getDetail(item?.metadata, 'campaign_limit') == '-1' ?
                                                    $t('Unlimited') : getDetail(item?.metadata, 'campaign_limit') }} {{
                                                        $t('Campaigns') }}</h3>
                                            </div>
                                            <div class="flex items-center text-gray-600 gap-3">
                                                <span>
                                                ...
                                                <h3>{{ getDetail(item?.metadata, 'message_limit') == '-1' ?
                                                    $t('Unlimited') : getDetail(item?.metadata, 'message_limit') }} {{
                                                        $t('Messages') }}</h3>
                                            </div>
                                            <div class="flex items-center text-gray-600 gap-3">
                                                <span>
                                                ...
                                                <h3>{{ getDetail(item?.metadata, 'contacts_limit') == '-1' ?
                                                    $t('Unlimited') : getDetail(item?.metadata, 'contacts_limit') }} {{
                                                        $t('Contacts') }}</h3>
                                            </div>
                                            <div class="flex items-center text-gray-600 gap-3">
                                                <span>
                                                ...
                                                <h3>{{ getDetail(item?.metadata, 'canned_replies_limit') == '-1' ?
                                                    $t('Unlimited') : getDetail(item?.metadata, 'canned_replies_limit')
                                                }} {{ $t('Canned replies') }}</h3>
                                            </div>
                                            <div class="flex items-center text-gray-600 gap-3">
                                                <span>
                                                ...
                                                <h3>{{ getDetail(item?.metadata, 'team_limit') == '-1' ? $t('Unlimited')
                                                    : getDetail(item?.metadata, 'team_limit') }} {{ $t('Users') }}</h3>
                                            </div>
                                            <div v-for="(value, key) in filteredAddons(item)"
                                                class="flex items-center text-gray-600 gap-3">
                                                <span>
                                                    <svg v-if="value == true" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <svg v-else class="text-red-500" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div v-if="props.enable_ai_billing == 1"
                                                class="flex items-center text-gray-600 gap-3">
                                                <span>
                                                    <svg v-if="getDetail(item?.metadata, 'ai_text_response_limit') && filteredAddons(item)['AI Assistant']"
                                                ...
                                                <h3>
                                                    <span v-if="filteredAddons(item)['AI Assistant']">{{
                                                        getDetail(item?.metadata, 'ai_text_response_limit') == '-1' ?
                                                            $t('Unlimited') : getDetail(item?.metadata,
                                                                'ai_text_response_limit') }}</span>
                                            ...
                                            <div v-if="props.enable_ai_billing == 1"
                                                class="flex items-center text-gray-600 gap-3">
                                                <span>
                                                    <svg v-if="getDetail(item?.metadata, 'ai_audio_response_limit') && filteredAddons(item)['AI Assistant']"
                                                        xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                                                        viewBox="0 0 16 16">
                                                        <g fill="none" stroke="currentColor" stroke-linecap="round"
                                                            stroke-linejoin="round" stroke-width="1.5">
                                                ...
                                                <h3>
                                                    <span v-if="filteredAddons(item)['AI Assistant']">{{
                                                        getDetail(item?.metadata, 'ai_audio_response_limit') == '-1' ?
                                                            $t('Unlimited') : getDetail(item?.metadata,
                                                                'ai_audio_response_limit') }}</span>
        ...
        <section id="section5" class="bg-gray-300/10 px-5 md:px-10 lg:px-20 py-20 2xl:px-60">
            <div>
                ...
                <div class="flex justify-center">
                    <h2 class="text-center text-3xl md:text-5xl font-bold w-[10em]">{{ $t(`Explore genuine client
                        feedback`) }}</h2>
                </div>
                <div class="flex justify-center">
                    <h3 class="text-center text-[18px] mt-5 w-[30em]">{{ $t(`Discover how businesses like yours
                        transformed with our software.Real stories of growth, innovation, and success`) }}</h3>
                </div>
                <div class="md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 space-y-4 md:space-y-0 mt-20">
                    <div v-for="(item, index) in props.reviews" :key="index" class="bg-white rounded-[15px] p-5">
                        <div class="flex">
                            <svg :class="item.rating >= 1 ? 'text-[#f7ba2f]' : 'text-gray-300'"
                            ...
                            <svg :class="item.rating >= 2 ? 'text-[#f7ba2f]' : 'text-gray-300'"
                                xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M12.86 10.44L11 6.06l-1.86 4.39l-4.75.41L8 14l-1.08 4.63L11 16.17l4.09 2.46L14 14l3.61-3.14zm3.73 10.26L11 17.34L5.42 20.7l1.46-6.35l-4.92-4.28l6.49-.57l2.55-6l2.55 6l6.49.57l-4.92 4.27z" />
                            </svg>
                            <svg :class="item.rating >= 3 ? 'text-[#f7ba2f]' : 'text-gray-300'"
                                xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M12.86 10.44L11 6.06l-1.86 4.39l-4.75.41L8 14l-1.08 4.63L11 16.17l4.09 2.46L14 14l3.61-3.14zm3.73 10.26L11 17.34L5.42 20.7l1.46-6.35l-4.92-4.28l6.49-.57l2.55-6l2.55 6l6.49.57l-4.92 4.27z" />
                            </svg>
                            <svg :class="item.rating >= 4 ? 'text-[#f7ba2f]' : 'text-gray-300'"
                                xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M12.86 10.44L11 6.06l-1.86 4.39l-4.75.41L8 14l-1.08 4.63L11 16.17l4.09 2.46L14 14l3.61-3.14zm3.73 10.26L11 17.34L5.42 20.7l1.46-6.35l-4.92-4.28l6.49-.57l2.55-6l2.55 6l6.49.57l-4.92 4.27z" />
                            </svg>
                            <svg :class="item.rating == 5 ? 'text-[#f7ba2f]' : 'text-gray-300'"
                                xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M12.86 10.44L11 6.06l-1.86 4.39l-4.75.41L8 14l-1.08 4.63L11 16.17l4.09 2.46L14 14l3.61-3.14zm3.73 10.26L11 17.34L5.42 20.7l1.46-6.35l-4.92-4.28l6.49-.57l2.55-6l2.55 6l6.49.57l-4.92 4.27z" />
                            </svg>
                        ...
                        <div class="flex justify-between items-center mt-5">
                            ...
                            <div>
                                <svg class="text-gray-500/10" xmlns="http://www.w3.org/2000/svg" width="3em"
        ...
        <section id="section6" class="px-5 md:px-10 lg:px-20 py-20">
            <div class="aos-init aos-animate" data-aos="fade-up" data-aos-duration="2000">
                ...
                <div class="text-center">
                    ...
                    <h2 class="text-3xl md:text-5xl/tight font-bold mt-3 mb-4">{{ $t('Frequently asked questions') }}
                    </h2>
                    <div class="flex justify-center">
                        <h3 class="text-center text-[18px] mt-5 w-[32em]">{{ $t(`Learn how our platform works and find
                            solutions to common queries.Need more help ? Reach out to our support team for personalized
                            assistance`) }}</h3>
                    </div>
                </div>
                ...
                <div data-fc-type="accordion" class="mt-14 lg:w-3/4 lg:mx-auto 2xl:w-2/3 space-y-2 md:px-20">
                    <!-- 1 -->
                    <div v-for="(item, index) in props.faqs.data" :key="index"
                        class="border border-gray-300 rounded-lg">
                        <button @click="selectedFaq = index + 1"
                            class="inline-flex p-5 items-center justify-between w-full text-left transition fc-collapse"
                            data-fc-type="collapse">
                            <div v-html="item.question"></div>
                            <div>
                                <svg v-if="selectedFaq != index + 1" xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M16.75 11.989a1.82 1.82 0 0 1-.57 1.36l-6.82 6.1a1.27 1.27 0 0 1-.65.31h-.19a1.3 1.3 0 0 1-.52-.1a1.23 1.23 0 0 1-.54-.47a1.19 1.19 0 0 1-.21-.68v-13a1.2 1.2 0 0 1 .21-.69a1.23 1.23 0 0 1 1.25-.56c.24.039.464.143.65.3l6.76 6.09c.19.162.344.363.45.59c.114.234.175.49.18.75" />
                                </svg>
                        ...
                        <div class="w-full overflow-hidden transition-[height] duration-300"
                            :class="selectedFaq === index + 1 ? '' : 'hidden'" style="">
                ...
                <div class="text-center mt-14">
                    <p class="inline-flex flex-wrap gap-1 bg-secondary/10 text-sm text-primary rounded-full py-2 px-5">
                        {{ $t('Still have unanswered questions?') }}<a :href="'mailto:' + props.companyConfig.email"
                            class="hover:text-primary hover:underline transition-all"> Contact Us</a></p>
                </div>
        ...
        <footer id="section7" class="bg-gray-300/10 px-5 md:px-10 lg:px-20 md:pt-10 pb-5 2xl:px-60">
            <div class="md:flex">
                <div class="md:w-1/4 lg:w-1/2">
                    <div>
                        <img class="max-w-[150px]" v-if="props.companyConfig.logo"
                ...
                <div class="md:w-3/4 lg:w-1/2 md:flex md:justify-between text-sm space-y-8 md:space-y-0">
                    <div>
                        ...
                        <div
                            class="flex md:justify-between space-x-10 md:space-x-10 lg:space-x-20 space-y-2 md:space-y-0">
                            <div class="space-y-2">
                                <div>
                                    <a href="#section2"
                                        class="border-b-2 border-[#fafbfb] hover:border-b-2 hover:border-black">{{
                                            $t('Features') }}</a>
                                </div>
                                <div>
                                    <a href="#section3"
                            ...
                            <div v-if="pages.length > 0" class="space-y-2">
                                <div v-for="page in pages" :key="page.id">
                                    <Link :href="'/pages/' + formattedName(page.name)"
                                        class="border-b-2 border-[#fafbfb] hover:border-b-2 hover:border-black">{{
                                            $t(page.name) }}</Link>
                                </div>
                            </div>
                    ...
                    <div>
                        <div>
                            ...
                            <p class="mb-2">{{ $t('Email') }}: <a :href="'mailto:' + props.companyConfig.email"
                                    class="hover:underline">{{ props.companyConfig.email }}</a></p>
                            <p class="mb-4">{{ $t('Phone') }}: <a :href="'tel:' + props.companyConfig.phone"
                                    class="hover:underline">{{ props.companyConfig.phone }}</a></p>
                            <div class="flex space-x-4">
                                <a v-if="facebookUrl" :href="facebookUrl" class="cursor-pointer">
                                    <svg class="hover:text-secondary" xmlns="http://www.w3.org/2000/svg" width="18"
