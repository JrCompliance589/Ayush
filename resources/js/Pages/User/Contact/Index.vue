...
<template>
  <AppLayout>
    <div
      class="lg:h-[calc(100vh-65px)] overflow-hidden bg-gradient-to-br from-gray-50 to-orange-50/30"
    >
      <div class="grid grid-cols-12 lg:h-full">
        <!-- Sidebar -->
        <div
          class="col-span-12 lg:col-span-4 bg-white shadow-sm lg:shadow-xl lg:flex flex-col"
        >
          <!-- Header -->
            ...
            <div class="flex items-center justify-between mb-0">
              <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                  {{ props.rowCount }} {{ $t("total contacts") }}
                </p>
              </div>
              <Link
                href="/contacts/add"
        ...
        <!-- Main Content Area -->
        <div
          v-if="contact || $page.url === '/contacts/add'"
          class="absolute inset-0 lg:inset-auto lg:static bg-white col-span-12 lg:col-span-8 lg:overflow-hidden"
        >
        <Link href="/contacts" class="inline-flex lg:hidden items-center gap-2 px-6 py-3 m-4 bg-white hover:bg-slate-50 text-slate-700 rounded-xl font-medium transition-all duration-200 border border-slate-200 shadow-sm hover:shadow-md">
        ...
        <div
          v-else
          class="hidden lg:block col-span-12 lg:col-span-8 lg:overflow-hidden"
        >
          <div class="flex items-center justify-center h-full p-8">
            <div class="text-center max-w-md">
              ...
              <p class="text-gray-500 mb-8">
                {{ $t("Choose a contact from the list or create a new one") }}
              </p>
