  ...
  <AppLayout>
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-gray-50 p-4 md:p-8">
        ...
        <div class="relative">
          ...
          <div class="relative bg-white/80 backdrop-blur-sm border border-gray-200 rounded-3xl p-6 shadow-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link v-if="hasPermission('contacts')" href="/contacts/add"
              ...
              <Link v-if="hasPermission('campaigns')" href="/campaigns/create"
              ...
              <Link v-if="hasPermission('templates')" href="/templates/create"
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        <!-- Contacts -->
        <div v-if="hasPermission('contacts')" class="group relative">
          <div
        ...
        <!-- Campaigns -->
        <div v-if="hasPermission('campaigns')" class="group relative">
        ...
        <!-- Templates -->
        <div v-if="hasPermission('templates')" class="group relative">
          <div
        ...
        <!-- Chats -->
        <div v-if="hasPermission('chats')" class="group relative col-span-2 lg:col-span-1">
          <div
          ...
          <div
            ...
            <div class="flex justify-between items-start mb-4">
              ...
              <div class="flex items-center gap-1 bg-emerald-50 rounded-lg px-2 py-1 border border-emerald-200">
                <TrendingUp v-if="isOwner" class="w-3 h-3 text-emerald-600" />
                <span v-else class="text-xs font-medium text-emerald-600">Assigned</span>
              </div>
            </div>
            <p class="text-gray-600 text-sm font-medium mb-1">{{ isOwner ? $t("All chats") : $t("My Assigned Chats") }}</p>
      ...
      <div class="grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="relative group">
            ...
            <div class="relative bg-white border border-gray-200 rounded-2xl p-6 shadow-lg">
              <div class="flex items-center justify-between mb-6">
                <div>
                  <h3 class="text-gray-900 text-xl font-bold mb-1">{{ isOwner ? 'Chat Analytics' : 'My Chat Analytics' }}</h3>
          ...
          <!-- Campaigns List -->
          <div v-if="hasPermission('campaigns')" class="relative group">
            <div
...
const hasPermission = (permission) => {
  ...
  return props.teamPermissions?.includes(permission) ?? false;
};
...
const series = computed(() => {
  // Use agent-specific data if not owner and has the data
  if (!props.isOwner && props.myInbound && props.myOutbound) {
    return [
      {
        name: trans("My Inbound chats"),
        data: props.myInbound,
      },
      {
        name: trans("My Outbound chats"),
        data: props.myOutbound,
      },
    ];
  }
  // Default to organization-wide data
  return [
    {
