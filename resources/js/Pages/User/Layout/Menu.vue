    ...
    <div class="flex-grow space-y-3 px-2 overflow-y-scroll">
        <div class="flex-1">
            <ul class="pt-2 space-y-1 text-sm mb-2">
                <li v-if="hasPermission('dashboard')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('chats')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('contacts')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('campaigns')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('templates')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('automation')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
            ...
            <ul class="pb-4 space-y-1 text-sm mt-2">
                <li v-if="hasPermission('team')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('settings')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('billing')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('support')" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate"
                ...
                <li v-if="hasPermission('developer_tools')"
...
const teamPermissions = computed(() => usePage().props.teamPermissions || []);
...
const hasPermission = (permission) => {
    ...
    if (teamRole.value === 'owner') {
        return true;
    }
    return teamPermissions.value.includes(permission);
};
