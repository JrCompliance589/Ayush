...
/*
|--------------------------------------------------------------------------
| INTERNAL ROUTES (Node.js → Laravel only)
|--------------------------------------------------------------------------
*/


Route::post('/internal/session-check', function (Request $request) {
...
Route::get('/chats/download-inbound', [App\Http\Controllers\User\ChatController::class, 'downloadInboundChat'])->name('chats.download-inbound');

Route::prefix('/api/users')->group(function () {
    Route::get('{id}/balance-history', [BalanceHistoryController::class, 'index']);
});
Route::post('/api/users/{id}/increment-balance', [BalanceController::class, 'incrementBalance']);
Route::post('/api/users/{id}/decrement-balance', [BalanceController::class, 'decrementBalance']);
...
Route::post('/webhook/lifetime-addon-payment', [App\Http\Controllers\User\LifetimeAddonPurchaseController::class, 'handleWebhook']);
...
Route::middleware(['auth:user'])->group(function () {
    ...
    Route::group(['middleware' => ['check.email.verification']], function () {
        ...
        Route::group(['middleware' => ['check.organization']], function () {
            // User Panel Routes - Dashboard has special permission handling
            ...
            Route::group(['middleware' => 'check.client.role'], function () {
                ...
                Route::match(['get', 'post'], '/billing', [App\Http\Controllers\User\BillingController::class, 'index'])->name('user.billing.index')->middleware('check.team.permission:billing');
                Route::post('/pay', [App\Http\Controllers\User\BillingController::class, 'pay'])->name('user.billing.pay')->middleware('check.team.permission:billing');
                Route::resource('subscription', App\Http\Controllers\User\SubscriptionController::class)->middleware('check.team.permission:billing');
                Route::post('/subscription/coupon/apply/{id}', [App\Http\Controllers\User\SubscriptionController::class, 'applyCoupon'])->middleware('check.team.permission:billing');
                Route::get('/subscription/coupon/remove/{id}', [App\Http\Controllers\User\SubscriptionController::class, 'removeCoupon'])->middleware('check.team.permission:billing');
                    ...
                    // Lifetime Addon Purchase Routes
                    Route::get('/lifetime-addons', [App\Http\Controllers\User\LifetimeAddonPurchaseController::class, 'index'])->name('user.lifetime-addons.index')->middleware('check.team.permission:billing');
                    Route::post('/lifetime-addons/purchase', [App\Http\Controllers\User\LifetimeAddonPurchaseController::class, 'createPayment'])->name('user.lifetime-addons.purchase')->middleware('check.team.permission:billing');
                    Route::get('/lifetime-addons/payment-callback', [App\Http\Controllers\User\LifetimeAddonPurchaseController::class, 'paymentCallback'])->name('user.lifetime-addons.callback')->middleware('check.team.permission:billing');
                    Route::get('/lifetime-addons/usage', [App\Http\Controllers\User\LifetimeAddonPurchaseController::class, 'getUsageSummary'])->name('user.lifetime-addons.usage')->middleware('check.team.permission:billing');
                ...
                Route::post('/templates/carousel/{uuid}', [App\Http\Controllers\User\TemplateController::class, 'Carouselupdate']);
                ...
                Route::group(['middleware' => 'check.client.role'], function () {
                    ...
                    Route::get('/settings/sheet-sync', [App\Http\Controllers\User\SheetSyncController::class, 'index']);
                    Route::post('/settings/sheet-sync', [App\Http\Controllers\User\SheetSyncController::class, 'store']);
                    Route::post('/settings/sheet-sync/test', [App\Http\Controllers\User\SheetSyncController::class, 'test']);
                    Route::post('/settings/sheet-sync/zoho/generate-token', [App\Http\Controllers\User\SheetSyncController::class, 'zohoGenerateToken']);
                    Route::get('/settings/sheet-sync/zoho/callback', [App\Http\Controllers\User\SheetSyncController::class, 'zohoCallback']);
                    ...
                    Route::put('/team/{uuid}/permissions', [App\Http\Controllers\User\TeamController::class, 'updatePermissions'])->name('team.permissions.update');
                    Route::get('/team/{uuid}/permissions', [App\Http\Controllers\User\TeamController::class, 'getPermissions'])->name('team.permissions.get');
                    Route::post('/team/invite/{id}/resend', [App\Http\Controllers\User\TeamController::class, 'resendInvite'])->name('team.invite.resend');
                    Route::delete('/team/invite/{id}', [App\Http\Controllers\User\TeamController::class, 'deleteInvite'])->name('team.invite.delete');
...
Route::prefix('admin')->middleware(['auth:admin'])->group(function () {
    ...
    Route::resource('team/roles', App\Http\Controllers\Admin\RoleController::class)->names('team.roles');
    ...
    Route::post('/lifetime-addons', [App\Http\Controllers\Admin\LifetimeAddonController::class, 'store'])->name('admin.lifetime-addons.store');
    Route::get('/lifetime-addons/{uuid}', [App\Http\Controllers\Admin\LifetimeAddonController::class, 'show'])->name('admin.lifetime-addons.show');
    Route::put('/lifetime-addons/{uuid}', [App\Http\Controllers\Admin\LifetimeAddonController::class, 'update'])->name('admin.lifetime-addons.update');
    Route::delete('/lifetime-addons/{uuid}', [App\Http\Controllers\Admin\LifetimeAddonController::class, 'destroy'])->name('admin.lifetime-addons.destroy');
    ...
    Route::get('/settings/terms-conditions', [App\Http\Controllers\Admin\SettingController::class, 'termsConditions']);
    Route::get('/settings/bank', [App\Http\Controllers\Admin\SettingController::class, 'bank']);    
    Route::get('/settings/products', [App\Http\Controllers\Admin\SettingController::class, 'products']);    
    Route::get('/settings/tds-tax-slabs', [App\Http\Controllers\Admin\SettingController::class, 'tdsTaxSlabs']);    
